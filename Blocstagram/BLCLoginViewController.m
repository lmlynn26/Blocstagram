...
//  Blocstagram
//
//  Created by Larry Lynn on 4/24/15.
...
- (void)viewDidLoad {
    ...
    // sets Navigation Bar title to say "Login"
    
    self.title = NSLocalizedString(@"Login", @"Login");

}

// creates a Back button in top left of Navigation bar to return to login if user pushes the "Forgot password" 
...
- (void) dealloc {
    //removing this line causes a weird flickering effect when you relaunch the app after loggin in, as the web view is briefly displayed, automatically authenticates with cookies, returns the access token, and dismisses the login view, sometimes in less than a second
