...
//  
//
//  Created by Larry Lynn on 10/23/15.
//
//
...
//@interface BLCPostToInstagramViewController ()
...
//    [self.filterCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
    ...
    [self.filterCollectionView registerClass:[BLCCollectionViewCellSubClass class] forCellWithReuseIdentifier:@"cell"];
